...
class TBCalendarHeaderView: UIView {
    ...
    func createAttrStr(monthStr: String, yearStr: String) -> NSMutableAttributedString{
        let monthDict = [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 24), NSAttributedStringKey.foregroundColor:UIColor.UIColorFromRGB(rgb: 0x4F505F)]
        let yearDict = [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14), NSAttributedStringKey.foregroundColor:UIColor.UIColorFromRGB(rgb: 0x999999)]
